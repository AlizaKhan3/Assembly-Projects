...
.DATA
     OPTIONS  DB 13,10,"CALCULATOR --> Performs the following Operations ",13,10
              ...
              DB "Press '5' FOR SQUARED",13,10
              DB "Press '6' FOR EXIT",13,10
              DB "Press '7' FOR RETURN TO OPTIONS",13,10
              DB "----------------------------------------------",13,10
     ...
     SQ_1     DB " --> For Squared",13,10,'$'
     EX       DB " THANKYOU FOR YOUR TIME! :) ",13,10,'$'
     ANS      DB "ANSWER: ",13,10,'$'
     CONTINUE DB " DO YOU WANT TO CONTINUE? IF YES, PRESS '7' ",13,10,'$'
     OP1      DB ?
     OP2      DB ?
     CON      DB ?
     ;----------------------------------------------------------------------------------------------
...
NEWLINE ENDP
     ...
     START:          
                     ...
                     CMP AL, '6'
                     JE OPT6
                     JE   OPT7                  ;If none of the above, go back to main menu
