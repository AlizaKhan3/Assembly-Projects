...
press db 'Press Any Key to CONTtinue $'	;string to print the starting text
ulabel db '^ $'
maze db '   Maze Game   $'

lrlabel db 'CONTtrols are :         < + > $'
dlabel db 'v $'
...
random proc near	;procedure to get a random number
   ...
   xor  dx, dx
   mov  cx, 4    
   div  cx       ; here dx CONTtains the remainder of the division - from 0 to 9
   add  dl, '0'  ; to ascii from '0' to '9'
   ret
random endP


ENEMY proc near	;procedure to CONTtrol the movements of the ememies 
